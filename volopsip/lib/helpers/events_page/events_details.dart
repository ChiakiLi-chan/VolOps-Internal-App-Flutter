...
class _EventDetailsModalState extends State<EventDetailsModal> {
  ...
  void _groupAssignments() {
    attributeAssignments = {for (var attr in widget.event.attributes) attr: []};
  ...
  String formatTimestamp(DateTime? dt) {
    ...
    try {
      ...
      final monthName = months[local.month];
      ...
      return '$monthName ${local.day}, ${local.year} $hour12:$minuteStr$ampm';
    } catch (_) {
      return dt.toString();
    }
  }
